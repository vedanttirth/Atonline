 ...
 <body>
  ...
  <div class="container">
    ...
    <?php
      ...
      if(!$classes) {
        echo '<h3 class="no-classes">You haven\'t taken any class yet!</h3></div>';
      } else { 
        echo '<h3 class="no-classes">Click on a class to take attendance.</h3> </div>';
        ...
        <div class="modal-content">
          ...
          <hr>
            <div id="add_class_form">
              ...
              <?php foreach(range(date('Y',time()),2001) as $r) echo '<option>'.$r.'</option>'; ?>
              </select>
